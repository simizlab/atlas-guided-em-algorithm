...
set INPUT_PARAM_DIR=%BASE_PATH%results\apply_em_algorithm\using_atlas
set INPUT_LABEL_DIR=%BASE_PATH%data\preprocessed\label
set OUTPUT_DIR=%BASE_PATH%results\apply_maximum_a_posteriori
...
%EXE_PATH% %INPUT_FEATURE_DIR% %INPUT_ABD_MASK_DIR% %INPUT_PARAM_DIR% ^
            ...
            %FEATURE_NAME_LIST_PATH% %INPUT_ATLAS_DIR%
